...
export const WarpBackground: React.FC<WarpBackgroundProps> = ({
  ...
  return (
    <div className={cn("relative p-20", className)} {...props}>
      <div
        style={
          {
            ...
            "--beam-size": `${beamSize}%`,
            maskImage: "radial-gradient(circle at center, transparent 0 35%, black 55%)",
            WebkitMaskImage: "radial-gradient(circle at center, transparent 0 35%, black 55%)",
          } as React.CSSProperties
        }
        className={
