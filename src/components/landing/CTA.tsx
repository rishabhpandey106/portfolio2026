...
// import { WarpBackground } from '../rate/Warp';
import dynamic from "next/dynamic";

const WarpBackground = dynamic(
  () => import("../rate/Warp").then((mod) => mod.WarpBackground),
  { ssr: false }
);
...
export default function CTA({
  ...
  return (
    <>
      <WarpBackground className="mt-20 rounded-md border border-dashed" gridColor="var(--primary)">
